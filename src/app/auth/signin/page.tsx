          ...
          <div className="flex flex-col justify-center items-center">
            <div className="text-center space-y-8 w-full max-w-sm">
              ...
              <div className="space-y-3">
                ...
                <p className="text-lg text-cream/70">Sign in to continue playing</p>
              </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="w-full max-w-sm mx-auto space-y-8">
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-bold text-white mb-2">Sign In with Email</h3>
                <p className="text-cream/60">Enter your credentials below</p>
              </div>
              <form onSubmit={handleEmailSignIn} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={isSigningIn}
                    className="h-14 bg-black/30 backdrop-blur-sm border-2 border-yellow-500/30 text-white placeholder:text-cream/40 focus:border-yellow-500/60"
                  />
                </div>
